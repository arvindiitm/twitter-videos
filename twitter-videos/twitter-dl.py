...
if __name__ == '__main__':
	...
	tweets =pd.read_pickle("/.ChennaiIPL_TrainingCamp_2020-04-28T04_30_01.json_dataframe.pkl")
	for index, row in tweets.iterrows(): 
		print (row["tweet_url"]) 
		print(type(row["tweet_url"]))

		# twitter_dl = TwitterDownloader(row["tweet_url"], args.output, args.debug)
		# twitter_dl.download()		

	# pd.apply(func, axis=0, broadcast=None, raw=False, reduce=None, result_type=None, args=(), **kwds)
